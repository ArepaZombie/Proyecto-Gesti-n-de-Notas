...
<head>
    ...
    <title>Sistema de Gestión - Cursos</title>
...
<a href="ControllerCursos?value=Listar&trash=true" class="btn btn-outline-light m-1 py-2 position-absolute top-0 end-0">
...
<a class="btn btn-success mx-auto my-1" align="center"
	href="ControllerCursos?value=PreRegistrar">
...
<%
List<Curso> listado = (List<Curso>)request.getAttribute("listado");
if(listado!=null){
	for(Curso p:listado){
		%>
	<tr >	
		...
		<td class="text-center">		
			<a class="btn btn-primary btn-sm" href="ControllerCursos?value=Buscar&id=<%=p.getIdcurso()%>">
				<i class="fa-solid fa-pen-to-square"></i>			
			</a>
			<a class="btn btn-danger btn-sm" href="ControllerCursos?value=Borrar&id=<%=p.getIdcurso()%>"
