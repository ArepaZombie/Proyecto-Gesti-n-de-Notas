...
<head>
    ...
    <title>Sistema de Gestión - Profesores</title>
...
<a href="ControllerProfesor?value=Listar&trash=true" class="btn btn-outline-light m-1 py-2 position-absolute top-0 end-0">
...
<h2 class="mt-4">Lista de Profesores</h2>
<a class="btn btn-success mx-auto my-1" align="center"
	href="formularioProfesor.jsp">
